...
const posts = [
  {
    id: 1,
    title: "九州国际控股集团荣获2023年度最具创新力企业奖",
    content: `
      <p>九州国际控股集团凭借在数字科技领域的卓越创新，荣获2023年度最具创新力企业奖。这一奖项是对集团在技术研发、业务模式创新以及数字化转型方面所取得成就的高度认可。</p>
      <p>九州国际控股集团自成立以来，始终坚持以技术创新为核心驱动力，不断加大研发投入，推动业务模式升级。集团旗下的人工智能、大数据分析等核心技术已在多个行业得到广泛应用，为客户创造了显著价值。</p>
      <p>此次获奖，不仅是对九州国际控股集团过去成绩的肯定，更是对集团未来发展的激励。九州国际控股集团将继续秉持创新理念，不断突破技术瓶颈，为推动行业发展和社会进步做出更大贡献。</p>
    `,
    coverImage: "https://via.placeholder.com/1200x600?text=九州国际控股集团新闻",
  ...
  {
    id: 2,
    title: "九州国际控股集团发布新一代人工智能平台",
    content: `
      <p>九州国际控股集团正式发布新一代人工智能平台，助力企业数字化转型。该平台整合了集团最新的人工智能、大数据和云计算技术，能够为企业提供全方位的数字化解决方案。</p>
      ...
      <p>九州国际控股集团表示，新一代人工智能平台的发布，标志着集团在数字化转型领域迈出了重要一步。集团将继续加大技术研发投入，不断完善平台功能，为企业提供更加优质的数字化服务。</p>
    `,
  ...
  },
  {
    ...
    content: `
      ...
      <p>九州国际控股集团作为数字经济领域的领军企业，始终坚持以技术创新为核心，以客户需求为导向，不断完善企业发展战略，积极应对数字经济时代的挑战，实现了企业的快速发展。</p>
    `,
    coverImage: "https://via.placeholder.com/1200x600?text=数字经济战略",
    publishDate: new Date('2023-10-15'),
    category: 'insight',
    author: "九州国际控股集团战略规划部"
  }
];
...
const initialComments = [
  ...
  },
  {
    ...
    postId: 1,
    commenterName: "李女士",
    content: "九州国际控股集团的创新精神值得我们学习，期待看到更多的创新成果。",
